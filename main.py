""" This file is the main interactive part of the program. It combines all other functions and graph defined in other
files to display the ideal movie for the user to watch next."""
...
def clicked():
    ...
    # print(score)
    movie_to_watch = main_block_2.watch_next(movie_network, score)
    # print(movie_network.movies['user'].movie)
